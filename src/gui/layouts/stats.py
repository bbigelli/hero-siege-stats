...
class SatanicZoneRow(Row):
    def __init__(self):
        self.satanic_zone_display = SatanicZoneDisplay(size=Sizes.Medium)
        Row.__init__(self, [self.satanic_zone_display])

    def update_satanic(self, satanic_zone: SatanicZoneStats):
        if satanic_zone and satanic_zone.satanic_zone_info:
            self.satanic_zone_display.set_satanic_zone_info(satanic_zone.satanic_zone_info)
        else:
            self.satanic_zone_display.set_satanic_zone_info(None)
